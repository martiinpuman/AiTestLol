...
# 1032 executed with B-09 rework 2, B-21 merged (SharedKernel 231, Countries.Contracts 141,
# Countries.Hosting 105, Platform.Tenancy 242, Architecture 313); 854 before it.
# Re-measured at every merge, never inherited: B-04 alone measured 342, B-05 371,
# B-12 440, B-03.1 761, B-19 764, B-06.1 840, B-21 854, B-09 1032.
MIN_UNIT_TESTS="${AURORA_MIN_UNIT_TESTS:-1030}"
